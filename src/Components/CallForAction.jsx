  ...
  return (
    <div className="bg-white mt-14">
      <div className="container flex mx-auto">
        <div className="relative w-full isolate overflow-hidden shadow-xl bg-[#b67a3d] opacity-95 px-6 pt-16 sm:rounded-2xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          <svg
